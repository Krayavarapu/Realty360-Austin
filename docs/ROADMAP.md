...
1. **Phase 4.2–4.3** — Flip prediction schema + `POST /predict/flip` rules engine
...
| Flip deal config | `shared/flip/types.ts`, `shared/flip/config.ts`, `shared/flip/deal-costs.ts` |
